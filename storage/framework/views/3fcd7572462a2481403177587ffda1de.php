...
<?php $__env->startSection('content'); ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <li class="list-item">
                                            <span><input type="checkbox" class="chk-category" name="categories[]"
                                                    value="<?php echo e($category->id); ?>" id="category"
                                                    <?php if(in_array($category->id, $f_categories)): ?> checked="checked" <?php endif; ?>>
                                                <a href="#" class="py-1 menu-link"><?php echo e($category->name); ?></a>
                                            </span>
                                            <span
                                                class="text-right float-end"><?php echo e(\App\Models\Product::where('category_id', $category->id)->count()); ?></span>
                            ...
                            <div class="px-0 pb-0 accordion-body">
                                <div class="flex-wrap d-flex">
                                    <?php $__currentLoopData = ['XS', 'S', 'M', 'L', 'XL', 'XXL']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="#"
                                            class="swatch-size1 btn btn-sm btn-primary mb-3 me-3 js-filter <?php echo e(in_array($size, $f_sizes) ? 'active' : ''); ?>"
                                        ...
                                        <li class="list-item">
                                            ...
                                            <span class="py-1 menu-link">
                                                <input class="chk-brand" type="checkbox" name="brands[]"
                                                    ...
                                                    <?php if(in_array($brand->id, $f_brands)): ?> checked="checked" <?php endif; ?>>
                                                <?php echo e($brand->name); ?>

                                            </span>
                                            <span
                                                class="text-right float-end"><?php echo e(\App\Models\Product::where('brand_id', $brand->id)->count()); ?></span>
                                        </li>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p>No Brands</p>
                                    <?php endif; ?>
                    ...
                    <div class="mb-4 accordion-item">
                        ...
                        <div id="accordion-filter-price" class="border-0 accordion-collapse collapse show"
                            ...
                            <input class="price-range-slider" type="text" name="price_range" value=""
                                ...
                                data-slider-value="[<?php echo e($min_price); ?>, <?php echo e($max_price); ?>]" data-currency="$" />
            ...
            "pagination": {
              ...
              "clickable": true
                            ...
                            <div class="overflow-hidden slide-split h-100 d-block d-md-flex">
                                ...
                                <div class="slide-split_media position-relative">
                                    <div class="slideshow-bg" style="background-color: #f5e6e0;">
                                        <img loading="lazy"
                                            src="<?php echo e(asset('assets/images/portrait-young-handsome-bearded-man_1303-19639.jpg ')); ?>"
                ...
                <div class="mb-4 d-flex justify-content-between pb-md-2">
                    ...
                    <div
                        ...
                        <select class="order-1 w-auto py-0 border-0 shop-acs__select form-select order-md-0"
                            ...
                            <option value="9" <?php echo e($page_size == '9' ? 'selected' : ''); ?>>Show</option>
                            <option value="12" <?php echo e($page_size == '12' ? 'selected' : ''); ?>>12</option>
                            <option value="15" <?php echo e($page_size == '15' ? 'selected' : ''); ?>>15</option>
                            <option value="21" <?php echo e($page_size == '21' ? 'selected' : ''); ?>>21</option>
                            <option value="27" <?php echo e($page_size == '27' ? 'selected' : ''); ?>>27</option>

                        </select>
                        <select class="order-1 w-auto py-0 border-0 shop-acs__select form-select order-md-0"
                            aria-label="Sort Items" name="orderBy" id="orderBy">
                            <option value="-1" <?php echo e($order == '-1' ? 'selected' : ''); ?>>Default Sorting</option>
                                ...
                                <div class="mb-3 product-card mb-md-4 mb-xxl-5">
                                    <div class="pc__img-wrapper position-relative">
                                        ...
                                        <div class="swiper-container background-img js-swiper-slider"
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <a href="<?php echo e(route('website.shop.product.details', $product->slug)); ?>"><img
                                                            loading="lazy"
                                                                ...
                                                                <?php if(!empty($product->images)): ?>
                                                                    ...
                                                                    <?php $__currentLoopData = $galleryImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gimg): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                        <?php if(!empty($gimg) && file_exists(public_path('storage/uploads/products/gallery/' . $gimg))): ?>
                                                                            <a
                                                                                href="<?php echo e(route('website.shop.product.details', $product->slug)); ?>">
                                                                                <img loading="lazy"
                                                                        ...
                                                                        <?php else: ?>
                                                                            <a
                                                                                href="<?php echo e(route('website.shop.product.details', $product->slug)); ?>">
                                                                                <img loading="lazy"
                                                                                    src="<?php echo e(asset('storage/uploads/products/gallery/default.jpg')); ?>"
                                                                                    width="330" height="400"
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else: ?>
                                                <form name="addtocart-form" method="get"
                                                    action="<?php echo e(route('website.shop.product.details', $product->slug)); ?>">
                                                    <button type="submit"
                                    ...
                                    <div class="pc__info position-relative">
                                        ...
                                        <h6 class="pc__title"><a
                                                href="<?php echo e(route('website.shop.product.details', $product->slug)); ?>"><?php echo e($product->name); ?></a>
                                        </h6>
                                            ...
                                            <div class="reviews-group d-flex">
                                                ...
                                                <span class="fs-6 " style="color: #FACA51;">
                                                    ...
                                                    <span class="reviews-note text-lowercase ms-1"
                                                        style="color: black;">(<?php echo e($product->reviews->count()); ?>
                ...
                <nav class="mt-3 shop-pages d-flex justify-content-between align-items-center"
                    ...
                    <?php echo e($products->links('vendor.pagination.custom-pagination')); ?>
    ...
    <form id="frmfilter" action="<?php echo e(route('website.shop')); ?>" method="GET">
        <input type="hidden" name="page" value="<?php echo e($products->currentPage()); ?>">
        <input type="hidden" name="size" id="size" value="<?php echo e($page_size); ?>">
        <input type="hidden" name="order" id="order" value="<?php echo e($order); ?>">
        <input type="hidden" name="brands" id="hiddenBrands" value="<?php echo e(implode(',', $f_brands)); ?>">
        <input type="hidden" name="categories" id="hiddenCategories" value="<?php echo e(implode(',', $f_categories)); ?>">
        <input type="hidden" id="hiddenMinPrice" name="min" value="<?php echo e($min_price); ?>">
        <input type="hidden" id="hiddenMaxPrice" name="max" value="<?php echo e($max_price); ?>">
        <input type="hidden" name="sizes" id="hiddenSizes" value="<?php echo e(implode(',', $f_sizes)); ?>">
    </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/devshadin/ecommercesite.dev-shadin.com/resources/views/Website/shop.blade.php ENDPATH**/ ?>