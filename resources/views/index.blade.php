...
@section('content')
    ...
    "loop": true
                    ...
                    <div class="swiper-slide">
                        <div class="overflow-hidden position-relative h-100" id="h100">
                            <div class="bottom-0 slideshow-character position-absolute pos_right-center">
                                <img loading="lazy" src="{{ asset('storage/uploads/slides/' . $slide->image) }}"
                            ...
                            @foreach ($categories as $category)
                                <div class="swiper-slide">
                                    <img loading="lazy" class="h-auto mb-3 w-100 circular-image"
                                        src="{{ asset('storage/uploads/categories/' . $category->image) }}" width="124"
                                        height="124" alt="{{ $category->name }}" />
                                    <div class="text-center">
                                        <a href="{{ route('website.shop', ['categories' => $category->id]) }}"
                    ...
                    <div
                        ...
                        <div style="display: flex ; bottom: 2px;">
                            <h2>Summer Sale</h2><img height="30px" width="30px"
                                src="{{ asset('icon/icons8-celebration-48 (1).png') }}" />
                        </div>
              ...
              "breakpoints": {
                ...
                "1200": {
                  ...
                  "pagination": false
                                    ...
                                    @foreach ($saleProducts as $product)
                                        <div class="swiper-slide product-card product-card_style3">
                                            <div class="pc__img-wrapper">
                                                <a
                                                    href="{{ route('website.shop.product.details', ['product_slug' => $product->slug]) }}">
                                                    <img loading="lazy"
                                                ...
                                                <span
                                                    ...
                                                    style="background-color: {{ $product->quantity > 0 ? 'green' : 'red' }}">
                                            ...
                                            <div class="pc__info position-relative">
                                                <h6 class="pc__title">
                                                    <a
                                                        href="{{ route('website.shop.product.details', ['product_slug' => $product->slug]) }}">{{ $product->name }}</a>
                                                </h6>
                                ...
                                <a href="{{ route('website.shop') }}" style="text-decoration: underline"
            ...
            <section class="container category-banner">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-5 category-banner__item border-radius-10">
                            <img loading="lazy" class="h-auto"
                                src="{{ asset('assets/images/home/demo3/DSC02602.jpg') }}" width="690" height="665"
                                alt="" />
                    ...
                    <div class="col-md-6">
                        <div class="mb-5 category-banner__item border-radius-10">
                            <img loading="lazy" class="h-auto"
                                src="{{ asset('assets/images/home/demo3/DSC04407(1).jpg') }}" width="690"
                                height="665" alt="" />
                            <div class="category-banner__item-mark">Starting at $19</div>
                            <div class="category-banner__item-content">
            ...
            <section class="container p-4 shadow-lg products-grid rounded-4">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="mb-3 overflow-hidden shadow-lg product-card product-card_style3 mb-md-4 mb-xxl-5 rounded-4"
                                ...
                                <div class="pc__img-wrapper position-relative">
                                    ...
                                    <span
                                        class="top-0 px-3 py-1 m-2 text-white position-absolute start-0 rounded-pill fw-bold"
                                        style="background-color: {{ $product->quantity == 0 || empty($sizes) ? 'red' : 'green' }}">
                                        {{ $product->quantity == 0 || empty($sizes) ? 'Out of Stock' : 'In Stock' }}
                                    </span>
                                ...
                                <div class="p-3 text-center pc__info position-relative col-12">
                                    <h6 class="pc__title fw-semibold text-dark">
                                        <a href="{{ route('website.shop.product.details', $product->slug) }}"
                                            class="text-decoration-none text-dark"><strong>{{ $product->name }}</strong></a>
                                    </h6>
                                    ...
                                    <div class="gap-3 mt-3 d-flex justify-content-center">
                                        ...
                                        @php
                                            $sizes = json_decode($product->sizes, true); // true দিয়ে অ্যারে রিটার্ন করবে
                                        @endphp
                                        @if ($product->quantity == 0 || empty($sizes))
                                        ...
                                        @else
                                            ...
                                            @else
                                                {{-- <form action="{{ route('cart.add') }}" method="POST">
                                                    ...
                                                    <button class="px-4 py-2 shadow-sm btn btn-dark rounded-pill "
                                                        data-aside="cartDrawer" title="Add To Cart">
                                                        &#128722; Add To Cart
                                                    </button>
                                                </form> --}}
                                                <a href="{{ route('website.shop.product.details', $product->slug) }}"><button
                ...
                <div class="mt-2 text-center">
                    <a class="btn-link btn-link_lg default-underline text-uppercase fw-medium"
                        href="{{ route('website.shop') }}">View More</a>
                </div>
            </section>
        ...
        <div class="pt-1 pb-4 mt-5 mb-3 mb-xl-5">
            <section class="container shadow-lg products-grid rounded-4" style="padding: 60px">
                <h2 class="mb-3 section-title pb-xl-3 mb-xl-4">
                    Customer Feedbacks <img src="{{ asset('icon/icons8-message-48.png') }}">
                </h2>
                            ...
                            <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                <div class="p-4 text-center border rounded shadow-sm feedback-card">
                                    <div class="d-flex justify-content-center align-items-center">
                                        @if ($feedback->profile_picture == null)
                                        ...
                                        @else
                                            <img src="{{ asset('storage/uploads/feedback/' . $feedback->profile_picture) }}"
                                                alt="Profile Image" class="profile-img rounded-circle me-3"
                                                style="width: 60px; height: 60px; object-fit: cover;">
                                        @endif
                                        <div>
                                    ...
                                    <b class="mt-5 text-secondary">{{ $feedback->comment }}</b>
                                </div>
                            </div>
                        @empty
        ...
        {{-- Customer Feedback Submit Form  Section --}}
            ...
            <section id="feedback-form" class="container p-4 mt-5 products-grid rounded-4" style="display:none;">
                ...
                <div class="container shadow-lg rounded-4 mw-930" style="padding: 50px">
                    ...
                    <div class="contact-us__form">
                        <form name="contact-us-form" class="needs-validation" action="{{ route('feedback.submit') }}"
                            method="POST" enctype="multipart/form-data" id="feedbackForm">
                            @csrf
                            <h3 class="mb-5">Let us know what you think</h3> <img
                                src="{{ asset('icon/icons8-hugging-face-48.png') }}" />

                            <!-- Name Field -->
                            <div class="my-4 form-floating">
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    name="name" placeholder="Name *" value="{{ old('name') }}" id="name">
                            ...
                            <div class="my-4 form-floating">
                                <input type="text" class="form-control @error('phone') is-invalid @enderror"
                                    name="phone" placeholder="Phone *" value="{{ old('phone') }}" id="phone">
                            ...
                            <div class="my-4">
                                <textarea class="form-control form-control_gray @error('comment') is-invalid @enderror" name="comment"
                                    placeholder="Your Message" cols="30" rows="8" id="comment">{{ old('comment') }}</textarea>
                                <span class="text-danger"></span>
                                @error('comment')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
        ...
        <div class="pt-1 pb-4 mb-3 mb-xl-5">
            ...
            <section id="location-section" class="container p-4 mt-5 products-grid rounded-4">
                <h2 class="mb-3 text-center section-title pb-xl-3 mb-xl-4">
                    Our Shop Location <img src="{{ asset('icon/icons8-location-48.png') }}" alt="{{ __('Location') }}"
