       ...
       <div class="box-logo">
           <a href="{{ route('admin.index') }}" id="site-logo-inner">
               <img class="" id="logo_header" alt=""
                   src="{{ asset('assets/images/Sad-removebg-preview.png') }}"
                   data-light="{{ asset('assets/images/Sad-removebg-preview.png') }}"
                   data-dark="{{ asset('assets/images/Sad-removebg-preview.png') }}">
           </a>
