                    ...
                    <form class="form-new-product form-style-1" method="post" action="{{ route('admin.coupon.store') }}">
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('code') is-invalid @enderror" type="text"
                                placeholder="Coupon Code" name="code" tabindex="0" value="{{ old('code') }}"
                                aria-required="true">
                            @error('code')
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('value') is-invalid @enderror" type="text"
                                placeholder="Coupon Value" name="value" tabindex="0" value="{{ old('value') }}"
                                aria-required="true">
                            @error('value')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <fieldset class="name">
                            ...
                            <input class="flex-grow @error('cart_value') is-invalid @enderror" type="text"
                                placeholder="Cart Value" name="cart_value" tabindex="0" value="{{ old('cart_value') }}"
                                aria-required="true">
                            @error('cart_value')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
